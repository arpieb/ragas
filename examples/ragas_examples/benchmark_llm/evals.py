...
def load_dataset():
    ...
    if not os.path.exists(dataset_path):
        ...
        urllib.request.urlretrieve("https://raw.githubusercontent.com/arpieb/ragas-ng/main/examples/ragas_examples/benchmark_llm/datasets/discount_benchmark.csv", dataset_path)
