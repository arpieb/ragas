...
!!! note "Full code"
    You can view the full code for the agent and evaluation pipeline [here](https://github.com/arpieb/ragas-ng/tree/main/examples/ragas_examples/text2sql).
...
curl -o booksql_sample.csv https://raw.githubusercontent.com/arpieb/ragas-ng/main/examples/ragas_examples/text2sql/datasets/booksql_sample.csv
