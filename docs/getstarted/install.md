...
ragas-ng is not published to PyPI (`pip install ragas` installs the upstream
project), so install it from GitHub:

```bash
pip install git+https://github.com/arpieb/ragas-ng.git
```
